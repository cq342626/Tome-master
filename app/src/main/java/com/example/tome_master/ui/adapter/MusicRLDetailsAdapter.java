 ...
 * 作用 ：排行榜音乐列表详情适配器
 */
public class MusicRLDetailsAdapter extends RecyclerView.Adapter<MusicRLDetailsAdapter.Holder> {


    private List<Music> list;
    private Context context;

    public MusicRLDetailsAdapter(List<Music> list, Context context) {
        this.list = list;
        ...
        public Holder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (listener != null)
                        listener.onClickItem(getAdapterPosition() - 1);
                }
            });
        }
    }
