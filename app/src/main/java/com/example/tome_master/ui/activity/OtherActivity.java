...
import com.example.tome_master.ui.adapter.PaletteViewPagerAdapter;
...
public class OtherActivity extends BaseActivity {
    @BindView(R.id.palette_toolbar)
    Toolbar toolbar;
    @BindView(R.id.palette_toolbar_tab)
    TabLayout toolbar_tab;
    @BindView(R.id.palette_main_vp_container)
